...
const FeatureList = [
  {
    title: 'Front-end Dev',
    Svg: require('@site/static/img/app-launch.svg').default,
    // description: <>Docusaurus was designed from the ground up to be easily installed and used to get your website up and running quickly.</>,
  },
  {
    title: 'Studying',
    Svg: require('@site/static/img/studying.svg').default,
    // description: (
    //   <>
  ...
  {
    title: 'Taking Notes',
    Svg: require('@site/static/img/taking-notes.svg').default,
